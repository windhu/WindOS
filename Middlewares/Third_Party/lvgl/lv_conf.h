 ...
 * - LV_OS_SDL2
 * - LV_OS_CUSTOM */
#define LV_USE_OS   LV_OS_NONE // Feng adjusted to FreeRTOS
...
#define LV_FONT_MONTSERRAT_18 1 // Feng adjusted enable
